...
- 🔬 **タブラ・レクタ研究タブ**: ヴィジュネル表を使った暗号化の仕組み研究
...
>![ヴィジュネル表から暗号文文字や鍵文字を特定](assets/screenshot2.png)
>
> *ヴィジュネル表から暗号文文字や鍵文字を特定*
...
- **数学的計算過程の表示**:
  ...
  - モジュロ26演算の詳細: `(平文 + 鍵) mod 26`（A=1では `+1` オフセット）
  - 数値 → 文字変換の過程
...
│   │   ├── indexing-mode.js # 表モード管理（A=0/A=1切替）
│   │   ├── validation.js   # 入力検証ロジック
│   │   └── utils.js        # ユーティリティ関数
│   ├── features/           # 機能別モジュール
│   │   ├── main-tab.js     # メイン暗号化タブ
│   │   ├── research-tab.js # タブラ・レクタ研究タブ
│   │   └── lab-tab.js      # 実験室タブ
│   └── ui/                 # UI制御層
